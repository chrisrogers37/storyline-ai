...
# Command test classes (TestQueueCommand, TestNextCommand, TestPauseCommand,
# TestResumeCommand, TestScheduleCommand, TestStatsCommand, TestHistoryCommand,
# TestLocksCommand, TestResetCommand, TestPauseIntegration) have been moved to
# test_telegram_commands.py as part of the telegram service refactor.

# Callback test classes (TestResumeCallbacks, TestResetCallbacks) remain here
# since the callback handlers are still in telegram_service.py.
