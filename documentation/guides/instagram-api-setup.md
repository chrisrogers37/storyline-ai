...
Note down:
- **Instagram Business Account ID**: `17841438002131111` (this goes in `INSTAGRAM_ACCOUNT_ID`)
- **Facebook Page ID**: `979362628588086` (used to get Page Access Token)
...
Example:
```
979362628588086?fields=access_token,name
```
...
INSTAGRAM_ACCESS_TOKEN=EAATTFpOQFRI...your_page_access_token...
...
INSTAGRAM_ACCOUNT_ID=17841438002131111
INSTAGRAM_ACCESS_TOKEN=EAATTFp...token1...

# Alternate: Thursday Media
# INSTAGRAM_ACCOUNT_ID=17841425591637879
# INSTAGRAM_ACCESS_TOKEN=EAATTFp...token2...
```
