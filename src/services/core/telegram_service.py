...
# are imported inside initialize()
...
class TelegramService(BaseService):
    ...
    # Callback handlers (posted, skipped, back, reject, resume, reset) have been
    # moved to telegram_callbacks.py. They are dispatched via self.callbacks in
    # _handle_callback().

    # Auto-post handler has been moved to telegram_autopost.py.
    # It is dispatched via self.autopost in _handle_callback().
